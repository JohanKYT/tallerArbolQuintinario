...
public class ArbolGUI {
        ...
        btnAgregarNodo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    int pos = Integer.parseInt(posNodo.getSelectedItem().toString());
                    ...
                    arbol.anadirNodo(nuevoNodo, nodoPadre, pos);
                    imprimirArbol();
                    dibujarArbolEnPanel();
    ...
    private void dibujarArbolEnPanel() {
        ...
        Graphics g = panelArbolScroll.getGraphics();
        ...
        if (g != null) {
            ...
            int panelWidth = panelArbolScroll.getWidth();
            int panelHeight = panelArbolScroll.getHeight();

            // Calcular la posición inicial (centrado horizontalmente y en la parte superior del panel)
            int x = panelWidth / 4;
            int y = 20; // Posición vertical inicial, puedes ajustar este valor según tus necesidades

            // Dimensiones para los nodos hijos
            int dimensionX = panelWidth / 8;
            int dimensionY = 100;
